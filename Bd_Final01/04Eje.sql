...
AS
BEGIN
    INSERT INTO Cliente VALUES ('7174678', 'Jaqupalomino@gmail',' 964902860', 'Isabel',' Jr.Las orquideaz');
END;
GO
...
AS
BEGIN
    SELECT * FROM Insumos WHERE In_Tipo = 'PROD01';
END;
GO
...
AS
BEGIN
    UPDATE Empleado SET Em_Salario = '1050' WHERE Id_Persona = @Id_Persona;
END;
GO
...
AS
BEGIN
    DELETE FROM Reserva WHERE Id_Reserva = 'RES01';
END;
GO
